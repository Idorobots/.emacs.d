...
(defun color-theme-tango ()
  ...
  (color-theme-install
   '(color-theme-tango
     ...
     (font-lock-constant-face ((t (:foreground "#76b23b" :bold t))))
     (font-lock-doc-face ((t (:foreground "#757a9a" :bold t))))
     (font-lock-keyword-face ((t (:foreground "#729fcf" :bold t))))
     (font-lock-string-face ((t (:foreground "#ffef6b" :italic t))))
     (font-lock-type-face ((t (:foreground "#76b23b" :bold t))))
     (font-lock-variable-name-face ((t (:foreground "#eeeeec"))))
     (font-lock-warning-face ((t (:bold t :foreground "#f50c00"))))
     (font-lock-function-name-face ((t (:foreground "#edd400" :bold t :italic t))))
     (comint-highlight-input ((t (:italic t :bold t))))
     (comint-highlight-prompt ((t (:foreground "#edd400"))))
